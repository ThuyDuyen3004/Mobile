...
public class TC07 extends BaseTest {
    ...
    public void CheckFilterOptions() throws InterruptedException {
        ...
        softAssert.assertTrue(homePage.isSortedByGiaThapDenCao(), "The list is not sorted correctly in ascending order of price.");

        // Kiểm tra sắp xếp từ cao đến thấp
        homePage.clickXemthem();
        homePage.selectGiaCaoDenThap();
        softAssert.assertTrue(homePage.isSortedByGiaCaoDenThap(), "The list is not sorted correctly in descending order of price.");
